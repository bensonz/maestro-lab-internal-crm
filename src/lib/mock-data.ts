...
export const MOCK_SERVER_CLIENTS = [
  {
    ...
    platformDetails: [
      ...
      { platformType: 'BETMGM', status: 'LIMITED', screenshots: [], username: 'jsmith_mgm', reviewedBy: null, reviewedAt: null, reviewNotes: null },
      ...
      { platformType: 'FANATICS', status: 'PENDING_REVIEW', screenshots: [], username: null, reviewedBy: null, reviewedAt: null, reviewNotes: null },
      { platformType: 'BALLYBET', status: 'LIMITED', screenshots: [], username: 'jsmith_bb', reviewedBy: null, reviewedAt: null, reviewNotes: null },
      { platformType: 'BETRIVERS', status: 'VERIFIED', screenshots: [], username: 'jsmith_br', reviewedBy: null, reviewedAt: null, reviewNotes: null },
      { platformType: 'BET365', status: 'PENDING_REVIEW', screenshots: [], username: null, reviewedBy: null, reviewedAt: null, reviewNotes: null },
      { platformType: 'PAYPAL', status: 'VERIFIED', screenshots: [], username: 'jsmith@paypal', reviewedBy: null, reviewedAt: null, reviewNotes: null },
  ...
  },
  {
    ...
    platformDetails: [
      ...
      { platformType: 'BETMGM', status: 'VERIFIED', screenshots: [], username: 'jbrown_mgm', reviewedBy: 'Sarah Chen', reviewedAt: '2026-02-11', reviewNotes: null },
      { platformType: 'CAESARS', status: 'VERIFIED', screenshots: [], username: 'jbrown_czr', reviewedBy: 'Sarah Chen', reviewedAt: '2026-02-11', reviewNotes: null },
      { platformType: 'FANATICS', status: 'VERIFIED', screenshots: [], username: 'jbrown_fan', reviewedBy: 'Sarah Chen', reviewedAt: '2026-02-12', reviewNotes: null },
      { platformType: 'BALLYBET', status: 'VERIFIED', screenshots: [], username: 'jbrown_bb', reviewedBy: 'Sarah Chen', reviewedAt: '2026-02-12', reviewNotes: null },
      { platformType: 'BETRIVERS', status: 'VERIFIED', screenshots: [], username: 'jbrown_br', reviewedBy: 'Sarah Chen', reviewedAt: '2026-02-13', reviewNotes: null },
      { platformType: 'BET365', status: 'VERIFIED', screenshots: [], username: 'jbrown_365', reviewedBy: 'Sarah Chen', reviewedAt: '2026-02-13', reviewNotes: null },
      { platformType: 'PAYPAL', status: 'VERIFIED', screenshots: [], username: 'jbrown@paypal', reviewedBy: 'Sarah Chen', reviewedAt: '2026-02-10', reviewNotes: null },
  ...
  },
  {
    ...
    platformDetails: [
      ...
      { platformType: 'BETMGM', status: 'LIMITED', screenshots: [], username: 'edavis_mgm', reviewedBy: null, reviewedAt: null, reviewNotes: null },
      { platformType: 'CAESARS', status: 'LIMITED', screenshots: [], username: 'edavis_czr', reviewedBy: null, reviewedAt: null, reviewNotes: null },
      { platformType: 'FANATICS', status: 'LIMITED', screenshots: [], username: 'edavis_fan', reviewedBy: null, reviewedAt: null, reviewNotes: null },
      { platformType: 'BALLYBET', status: 'LIMITED', screenshots: [], username: 'edavis_bb', reviewedBy: null, reviewedAt: null, reviewNotes: null },
      { platformType: 'BETRIVERS', status: 'LIMITED', screenshots: [], username: 'edavis_br', reviewedBy: null, reviewedAt: null, reviewNotes: null },
      { platformType: 'BET365', status: 'LIMITED', screenshots: [], username: 'edavis_365', reviewedBy: null, reviewedAt: null, reviewNotes: null },
      { platformType: 'PAYPAL', status: 'LIMITED', screenshots: [], username: 'edavis@paypal', reviewedBy: null, reviewedAt: null, reviewNotes: null },
...
export const MOCK_VERIFICATION_TASKS: VerificationTask[] = [
  {
    id: 'vt-1', clientRecordId: 'client-3', clientName: 'David Lee', platformType: 'DRAFTKINGS' as const, platformLabel: 'DraftKings',
  ...
  {
    id: 'vt-2', clientRecordId: 'client-2', clientName: 'Maria Garcia', platformType: 'BETMGM' as const, platformLabel: 'BetMGM',
