...
export default async function BackofficeActionHubPage() {
  ...
  const todayAllocations: FundAllocationEntry[] = (data?.todayAllocations ?? []).map((a) => ({
    ...
    clientName: [a.clientRecord?.firstName, a.clientRecord?.lastName].filter(Boolean).join(' ') || null,
    clientRecordId: a.clientRecord?.id ?? null,
    destinationClientName: [a.destinationClientRecord?.firstName, a.destinationClientRecord?.lastName].filter(Boolean).join(' ') || null,
    destinationClientRecordId: a.destinationClientRecord?.id ?? null,
