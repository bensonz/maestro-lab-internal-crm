  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="absolute top-4 right-4 rounded-md p-1 opacity-70 transition-all duration-200 hover:opacity-100 hover:bg-primary/10 focus:outline-none focus:ring-2 focus:ring-primary/30 disabled:pointer-events-none">
